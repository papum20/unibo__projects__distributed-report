...
scenarios (pause/resume, inject chaos by changing the state of some vehicles to
disconnected from the network, fetch information on them). No user data is thus
...
small amount of time (e.g. 1 second), after which data is considered stale and
no longer useful.
...
needed will also save some fuel, besides carrying fewer risks in general.
